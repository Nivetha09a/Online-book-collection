...
def explore(request):
	...
	nov_books = EBooksModel.objects.filter(category='Novel')
	science_books = EBooksModel.objects.filter(category='Science')
	return render(request, 'explore.html',{'edu_books':edu_books,'nov_books':nov_books,'science_books':science_books})
